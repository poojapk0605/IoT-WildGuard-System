...
class BaseActuatorSimTask():
	"""
	The `BaseActuatorSimTask` class simulates actuator behavior, managing commands to activate or deactivate the actuator and updating its state. It tracks the latest actuator response and logs command execution, ensuring only new commands are processed.

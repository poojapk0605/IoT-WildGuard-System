...
class SystemPerformanceData(BaseIotData):
	"""
	The `SystemPerformanceData` class extends `BaseIotData` to track system performance metrics such as CPU and memory utilization. It provides methods to set, retrieve, and update these metrics based on another `SystemPerformanceData` instance.

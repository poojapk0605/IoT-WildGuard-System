...
/**
 * The `SystemPerformanceManager` class periodically monitors system performance metrics (CPU, memory, and disk utilization) and sends the collected data to a listener for further processing. It schedules and manages tasks to gather this telemetry data at regular intervals.
 * 
 */

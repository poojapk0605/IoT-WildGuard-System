 ...
 * 
 * The `GatewayDeviceApp` class serves as the main entry point for the Gateway Device Application (GDA) in the IoT system. It initializes, starts, and stops the application, manages configurations, and handles the lifecycle of the `DeviceDataManager` to manage device data interactions.
 * 
 */
